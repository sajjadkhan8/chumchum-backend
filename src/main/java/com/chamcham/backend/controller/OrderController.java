...
public class OrderController {
    ...
    public ResponseEntity<OrderResponse> createOrder(
            ...
            @RequestParam(required = false) String barterDetails,
            @AuthenticationPrincipal AuthenticatedUser authUser
    ) {
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(orderService.createOrder(packageId, brandId, authUser.role(), amount, barterDetails));
    }
    ...
    public ResponseEntity<Map<String, Object>> updateOrderStatus(
        ...
        return ResponseEntity.ok(Map.of("error", false, "message", "Order status updated"));
    }
}
