...
public class AdminOperationsController {
    ...
    // Keep AdminController as the canonical /payments/withdrawals route; expose ops-specific alias here.
    @GetMapping("/payments/ops/withdrawals")
    ...
    @PatchMapping("/payments/ops/withdrawals/{id}/status")
