...
values
    ('a1f8db5c-6a4b-4d76-a001-0fd5f9c10101', 'ali.rehmani', 'Tech reviewer focused on practical smartphone and gadget content for Urdu-speaking audiences.', 'AVAILABLE', 'within_6_hours', 45000, 250000, 785000, 162000, 6.40, true, true, true, 4.80, 132, 286, true, true, 30000, '["Urdu", "English"]'::jsonb, '["TECH"]'::jsonb),
    ('a1f8db5c-6a4b-4d76-a001-0fd5f9c10102', 'sana.waqar', 'Beauty and lifestyle creator with a strong female audience in Lahore and Islamabad.', 'AVAILABLE', 'within_12_hours', 35000, 180000, 612000, 128000, 7.10, true, true, false, 4.70, 94, 211, true, true, 25000, '["Urdu", "Punjabi", "English"]'::jsonb, '["BEAUTY", "LIFESTYLE"]'::jsonb),
    ('a1f8db5c-6a4b-4d76-a001-0fd5f9c10103', 'hamza.tariq', 'Fitness coach and nutrition creator producing short-form workout plans and diet guides.', 'BUSY', 'within_24_hours', 30000, 140000, 458000, 97000, 5.80, true, false, true, 4.60, 73, 167, true, true, 20000, '["Urdu", "English"]'::jsonb, '["FITNESS", "HEALTH"]'::jsonb),
    ('a1f8db5c-6a4b-4d76-a001-0fd5f9c10104', 'zoya.naseem', 'Home decor and modest fashion content creator with strong regional reach in Punjab.', 'AVAILABLE', 'within_24_hours', 20000, 90000, 239000, 53000, 4.90, false, false, false, 4.40, 29, 81, true, true, 15000, '["Urdu", "Punjabi"]'::jsonb, '["HOME_DECOR", "FASHION"]'::jsonb),
    ('a1f8db5c-6a4b-4d76-a001-0fd5f9c10105', 'usman.shahid', 'Food vlogger covering street food and family dining spots across KPK and Islamabad.', 'AVAILABLE', 'within_12_hours', 25000, 120000, 371000, 89000, 6.10, false, true, true, 4.50, 41, 104, true, true, 18000, '["Urdu", "Pashto", "English"]'::jsonb, '["FOOD", "TRAVEL"]'::jsonb)
on conflict (id) do nothing;
...
values
    ...
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90103', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10102', 'Beauty Reels Campaign', 'Skincare Routine Reel + Stories', 'Routine-focused content demonstrating practical skincare use in humid weather conditions.', 'INSTAGRAM', 'FASHION', 'PAID', 'PAID', 88000, 'PKR', '["1 reel", "4 story frames", "Product mention in caption"]'::jsonb, 5, 2, 'ACTIVE', 'public', 'High trust skincare storytelling', 'Includes before/after shots and audience Q&A sticker to improve engagement.', true, true, true, 83, 'within_12_hours'),
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90104', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10103', 'Fitness Challenge', '30-Second Workout Challenge Reel', 'Motivational workout challenge designed for mass participation and hashtag growth.', 'INSTAGRAM', 'FITNESS', 'PAID', 'PAID', 76000, 'PKR', '["1 challenge reel", "2 reminder stories", "comment moderation for 24h"]'::jsonb, 4, 1, 'ACTIVE', 'public', 'Challenge format with strong completion rate', 'Built for sportswear and nutrition brands targeting urban youth segments.', true, false, false, 54, 'within_24_hours'),
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90105', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10104', 'Home Styling Reel', 'Living Room Styling Reel + Carousel', 'Budget-conscious decor transformation with product callouts.', 'INSTAGRAM', 'HOME_DECOR', 'PAID', 'PAID', 54000, 'PKR', '["1 reel", "1 carousel post", "product tags"]'::jsonb, 6, 1, 'ACTIVE', 'public', 'Affordable home decor storytelling', 'Targets first-time homeowners and newly married audience cohorts.', true, false, false, 25, 'within_24_hours'),
...
values
    ...
    ('30000000-0000-4000-8000-000000000011', '10000000-0000-4000-8000-000000000011', 'Daily Lifestyle Kit', 'Homecare Reel + Weekly Stories', 'Daily routine narrative for homecare and FMCG promotions.', 'INSTAGRAM', 'TRAVEL', 'PAID', 'PAID', 59000, 'PKR', '["1 reel", "5 stories"]'::jsonb, 6, 1, 'ACTIVE', 'public', 'Lifestyle consistency package', 'Fits recurring visibility campaigns and value messaging.', true, false, false, 33, 'within_12_hours'),
    ...
    ('30000000-0000-4000-8000-000000000014', '10000000-0000-4000-8000-000000000014', 'Gaming Launch Push', 'Livestream Highlight Reel + CTA Stories', 'High-energy gaming creative with launch and discount callouts.', 'INSTAGRAM', 'GAMING', 'PAID', 'PAID', 98000, 'PKR', '["1 highlight reel", "4 stories"]'::jsonb, 4, 1, 'ACTIVE', 'public', 'Gaming launch acceleration', 'Ideal for high-frequency promo windows and midnight drops.', true, true, true, 58, 'within_6_hours'),
    ('30000000-0000-4000-8000-000000000015', '10000000-0000-4000-8000-000000000015', 'Weekend Recipe Reel', 'Traditional Recipe Reel + Ingredient List', 'Recipe-led format optimized for saves and shares.', 'INSTAGRAM', 'FOOD', 'PAID', 'PAID', 64000, 'PKR', '["1 reel", "ingredient list story"]'::jsonb, 5, 1, 'ACTIVE', 'public', 'Food recipe conversion package', 'Built for FMCG and grocery category conversion flows.', true, false, true, 46, 'within_24_hours'),
    ...
    ('30000000-0000-4000-8000-000000000017', '10000000-0000-4000-8000-000000000017', 'Book Club Reel', 'Book Review Reel + Study Hacks', 'Reading culture and productivity hybrid content.', 'INSTAGRAM', 'EDUCATION', 'PAID', 'PAID', 50000, 'PKR', '["1 reel", "2 story cards"]'::jsonb, 5, 1, 'ACTIVE', 'public', 'Education-adjacent package', 'Works for publishing, stationery and student-centric offers.', true, false, false, 25, 'within_12_hours'),
    ('30000000-0000-4000-8000-000000000018', '10000000-0000-4000-8000-000000000018', 'Bike Safety Feature', 'Motorbike Safety Reel + Gear Breakdown', 'Safety-first creator unit for mobility brands.', 'INSTAGRAM', 'AUTOMOTIVE', 'PAID', 'PAID', 61000, 'PKR', '["1 reel", "2 safety stories"]'::jsonb, 5, 1, 'ACTIVE', 'public', 'Bike safety campaign package', 'Combines utility education with brand trust messaging.', true, false, false, 29, 'within_12_hours'),
...
values
    ('10000000-0000-4000-8000-000000000001', 'hira.ashraf',    'Modest fashion creator known for festive and everyday wardrobe styling.',                         'AVAILABLE', 'within_12_hours', 28000, 125000, 354000, 76000, 6.90, true,  true,  false, 4.70, 66, 149, true, true, 20000, '["Urdu", "English"]'::jsonb,          '["FASHION"]'::jsonb),
    ('10000000-0000-4000-8000-000000000002', 'bilal.naeem',    'Consumer tech explainer focused on value-for-money gadgets and smartphones.',                    'AVAILABLE', 'within_6_hours',  32000, 165000, 428000, 94000, 6.20, true,  true,  true,  4.80, 71, 172, true, true, 25000, '["Urdu", "English"]'::jsonb,          '["TECH"]'::jsonb),
    ('10000000-0000-4000-8000-000000000003', 'mariam.ikram',   'Parenting creator covering practical routines for young urban families.',                        'AVAILABLE', 'within_24_hours', 22000, 95000,  266000, 51000, 5.70, false, false, false, 4.50, 38, 96,  true, true, 15000, '["Urdu", "English"]'::jsonb,          '["PARENTING_FAMILY", "LIFESTYLE"]'::jsonb),
    ('10000000-0000-4000-8000-000000000004', 'ahmed.sheraz',   'Automotive reviewer producing ownership-cost and resale-value explainers.',                     'AVAILABLE', 'within_12_hours', 30000, 150000, 301000, 69000, 5.90, true,  false, true,  4.60, 47, 114, true, true, 22000, '["Urdu", "English"]'::jsonb,          '["AUTOMOTIVE", "TECH"]'::jsonb),
    ('10000000-0000-4000-8000-000000000005', 'kinza.rana',     'Skincare educator creating climate-appropriate routines for Pakistan audiences.',               'AVAILABLE', 'within_12_hours', 26000, 110000, 332000, 74000, 7.00, true,  true,  false, 4.70, 59, 137, true, true, 18000, '["Urdu", "Punjabi", "English"]'::jsonb, '["BEAUTY"]'::jsonb),
    ('10000000-0000-4000-8000-000000000006', 'daniyal.qureshi','Food discovery creator covering local dining and app-based offers in South Punjab.',           'AVAILABLE', 'within_24_hours', 24000, 98000,  281000, 58000, 6.00, false, true,  true,  4.50, 42, 101, true, true, 17000, '["Urdu", "Saraiki", "English"]'::jsonb, '["FOOD"]'::jsonb),
    ('10000000-0000-4000-8000-000000000007', 'ayesha.sami',    'Education creator helping students with exam prep and productivity systems.',                   'AVAILABLE', 'within_24_hours', 18000, 76000,  219000, 47000, 5.40, false, false, false, 4.40, 31, 79,  true, true, 12000, '["Urdu", "English", "Pashto"]'::jsonb, '["EDUCATION"]'::jsonb),
    ('10000000-0000-4000-8000-000000000008', 'talha.javed',    'Travel vlogger focused on domestic routes, budgets, and itinerary planning.',                  'AVAILABLE', 'within_24_hours', 27000, 118000, 247000, 55000, 5.60, false, false, false, 4.50, 34, 88,  true, true, 18000, '["Urdu", "English"]'::jsonb,          '["TRAVEL", "LIFESTYLE"]'::jsonb),
    ('10000000-0000-4000-8000-000000000009', 'meesha.khalid',  'Home organization creator focused on affordable household optimization.',                       'AVAILABLE', 'within_24_hours', 19000, 86000,  208000, 46000, 5.10, false, false, false, 4.30, 26, 67,  true, true, 13000, '["Urdu", "Sindhi"]'::jsonb,           '["HOME_DECOR"]'::jsonb),
    ('10000000-0000-4000-8000-000000000010', 'farhan.aslam',   'Cricket analyst with high-retention short videos around match cycles.',                        'AVAILABLE', 'within_12_hours', 25000, 130000, 396000, 84000, 6.30, true,  true,  true,  4.70, 52, 126, true, true, 19000, '["Urdu", "English"]'::jsonb,          '["SPORTS", "ENTERTAINMENT"]'::jsonb),
    ('10000000-0000-4000-8000-000000000011', 'iqra.hassan',    'Lifestyle creator with strong female audience in central Punjab.',                             'AVAILABLE', 'within_12_hours', 21000, 92000,  256000, 52000, 5.80, false, false, false, 4.50, 37, 90,  true, true, 14000, '["Urdu", "Punjabi"]'::jsonb,          '["LIFESTYLE", "HOME_DECOR"]'::jsonb),
    ('10000000-0000-4000-8000-000000000012', 'saad.farooq',    'Personal finance creator simplifying digital banking for salaried users.',                    'AVAILABLE', 'within_12_hours', 34000, 170000, 312000, 68000, 5.50, true,  false, true,  4.60, 45, 109, true, true, 25000, '["Urdu", "English"]'::jsonb,          '["BUSINESS_FINANCE"]'::jsonb),
    ('10000000-0000-4000-8000-000000000013', 'nida.kamran',    'Nutrition creator sharing practical wellness habits for working families.',                    'AVAILABLE', 'within_24_hours', 23000, 98000,  241000, 49000, 5.90, false, false, false, 4.50, 33, 82,  true, true, 16000, '["Urdu", "English"]'::jsonb,          '["HEALTH", "FITNESS"]'::jsonb),
    ('10000000-0000-4000-8000-000000000014', 'umair.latif',    'Gaming creator covering mobile esports and gear recommendations.',                             'AVAILABLE', 'within_6_hours',  30000, 145000, 377000, 91000, 6.80, true,  true,  true,  4.70, 49, 121, true, true, 22000, '["Urdu", "English"]'::jsonb,          '["GAMING"]'::jsonb),
    ('10000000-0000-4000-8000-000000000015', 'rabia.yousaf',   'Home-cooking creator focused on weekly meal planning and traditional recipes.',               'AVAILABLE', 'within_24_hours', 20000, 88000,  289000, 61000, 6.20, false, true,  false, 4.60, 40, 97,  true, true, 15000, '["Urdu", "Punjabi"]'::jsonb,          '["FOOD"]'::jsonb),
    ('10000000-0000-4000-8000-000000000016', 'adnan.maqsood',  'Agri creator producing practical content for modern farming workflows.',                      'AVAILABLE', 'within_24_hours', 26000, 116000, 184000, 39000, 5.00, false, false, false, 4.30, 24, 58,  true, true, 17000, '["Urdu", "Punjabi"]'::jsonb,          '["GENERAL", "TECH"]'::jsonb),
    ('10000000-0000-4000-8000-000000000017', 'mahnoor.zahid',  'Books and study productivity creator for university audiences.',                              'AVAILABLE', 'within_12_hours', 17000, 74000,  196000, 43000, 5.30, false, false, false, 4.40, 28, 72,  true, true, 11000, '["Urdu", "English"]'::jsonb,          '["EDUCATION"]'::jsonb),
    ('10000000-0000-4000-8000-000000000018', 'shahzaib.rauf',  'Motorbike creator focused on maintenance and rider safety.',                                  'AVAILABLE', 'within_12_hours', 22000, 100000, 267000, 57000, 5.70, false, false, true,  4.50, 35, 87,  true, true, 16000, '["Urdu", "Pashto"]'::jsonb,           '["AUTOMOTIVE"]'::jsonb),
    ('10000000-0000-4000-8000-000000000019', 'areeba.naz',     'Bridal and festive fashion creator known for high purchase-intent content.',                  'AVAILABLE', 'within_12_hours', 32000, 155000, 348000, 81000, 6.60, true,  true,  false, 4.70, 54, 132, true, true, 24000, '["Urdu", "English"]'::jsonb,          '["FASHION", "BEAUTY"]'::jsonb),
    ('10000000-0000-4000-8000-000000000020', 'hassan.imran',   'Comedy creator with strong short-form reach in metro markets.',                               'AVAILABLE', 'within_6_hours',  28000, 138000, 503000, 125000,7.20, true,  true,  true,  4.80, 63, 158, true, true, 21000, '["Urdu", "English"]'::jsonb,          '["ENTERTAINMENT"]'::jsonb)
on conflict (id) do update set
...
values
    ('31000000-0000-4000-8000-000000000002', 'sara.islamabad', 'Islamabad-focused lifestyle and retail creator covering openings, local deals, and family shopping content.', 'AVAILABLE', 'within_6_hours', 35000, 165000, 412000, 99000, 6.80, true, true, true, 4.80, 76, 183, true, true, 25000, '["Urdu", "English"]'::jsonb, '["LIFESTYLE", "BUSINESS_FINANCE"]'::jsonb)
on conflict (id) do nothing;
