...
values
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90101', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10101', 'YouTube Deep Review', 'Urdu Smartphone Deep-Dive Review', 'Detailed 8-10 minute review with benchmark tests and buying advice tailored for Pakistan market.', 'YOUTUBE', 'TECHNOLOGY_GADGETS', 'PAID', 'PAID', 185000, 'PKR', '["8-10 min YouTube video", "Product links in description", "48-hour pinned comment support"]'::jsonb, 7, 2, 'ACTIVE', 'public', 'Long-form video review with conversion intent', 'Includes product testing, feature breakdown, and value comparison with local alternatives.', true, true, true, 72, 'within_6_hours'),
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90102', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10101', 'Instagram Reels Bundle', '2 Tech Reels + 3 Story Frames', 'High-retention reels and swipe-up stories focused on discount and launch messaging.', 'INSTAGRAM', 'TECHNOLOGY_GADGETS', 'PAID', 'PAID', 95000, 'PKR', '["2 Instagram reels", "3 story frames", "Campaign hashtag placement"]'::jsonb, 4, 1, 'ACTIVE', 'public', 'Short-form launch package', 'Optimized for first-week launch traction and limited-time offer CTAs.', true, false, true, 118, 'within_6_hours'),
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90103', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10102', 'Beauty Reels Campaign', 'Skincare Routine Reel + Stories', 'Routine-focused content demonstrating practical skincare use in humid weather conditions.', 'INSTAGRAM', 'FASHION_BEAUTY', 'PAID', 'PAID', 88000, 'PKR', '["1 reel", "4 story frames", "Product mention in caption"]'::jsonb, 5, 2, 'ACTIVE', 'public', 'High trust skincare storytelling', 'Includes before/after shots and audience Q&A sticker to improve engagement.', true, true, true, 83, 'within_12_hours'),
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90104', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10103', 'Fitness Challenge', '30-Second Workout Challenge Reel', 'Motivational workout challenge designed for mass participation and hashtag growth.', 'INSTAGRAM', 'FITNESS_HEALTH', 'PAID', 'PAID', 76000, 'PKR', '["1 challenge reel", "2 reminder stories", "comment moderation for 24h"]'::jsonb, 4, 1, 'ACTIVE', 'public', 'Challenge format with strong completion rate', 'Built for sportswear and nutrition brands targeting urban youth segments.', true, false, false, 54, 'within_24_hours'),
    ...
    ('c3b5d1f4-88de-4ac2-9101-3f01b8d90106', 'a1f8db5c-6a4b-4d76-a001-0fd5f9c10105', 'Food Vlog Feature', 'Restaurant Feature Video + Reels Teaser', 'On-location restaurant coverage with taste notes, pricing, and ordering tips.', 'YOUTUBE', 'FOOD_BEVERAGE', 'PAID', 'PAID', 102000, 'PKR', '["5-7 min vlog", "1 teaser reel", "location tag + menu highlights"]'::jsonb, 6, 2, 'ACTIVE', 'public', 'City-focused restaurant spotlight', 'Works well for dine-in and delivery brands launching city-level offers.', true, true, true, 61, 'within_12_hours')
on conflict (id) do nothing;
...
values
    ('30000000-0000-4000-8000-000000000001', '10000000-0000-4000-8000-000000000001', 'Festive Styling Reels', '2 Festive Outfit Reels + Stories', 'Festive and wedding-season outfit storytelling with conversion intent.', 'INSTAGRAM', 'FASHION_BEAUTY', 'PAID', 'PAID', 92000, 'PKR', '["2 reels", "4 stories", "product tags"]'::jsonb, 5, 2, 'ACTIVE', 'public', 'Festive fashion conversion package', 'Designed for Eid and wedding campaign launches with strong CTR framing.', true, true, true, 68, 'within_12_hours'),
    ('30000000-0000-4000-8000-000000000002', '10000000-0000-4000-8000-000000000002', 'Tech Launch Kit', 'YouTube Review + Reels Teaser', 'Launch-week full-funnel package for electronics and marketplace campaigns.', 'YOUTUBE', 'TECHNOLOGY_GADGETS', 'PAID', 'PAID', 165000, 'PKR', '["1 review video", "1 teaser reel", "comment support"]'::jsonb, 7, 2, 'ACTIVE', 'public', 'Launch week tech package', 'Combines long-form trust and short-form awareness for product launches.', true, true, true, 74, 'within_6_hours'),
    ...
    ('30000000-0000-4000-8000-000000000005', '10000000-0000-4000-8000-000000000005', 'Skincare Conversion Reel', 'Routine Reel + Q&A Stories', 'Skincare routine content aligned with humid-weather concerns.', 'INSTAGRAM', 'FASHION_BEAUTY', 'PAID', 'PAID', 79000, 'PKR', '["1 reel", "3 stories", "Q&A"]'::jsonb, 5, 2, 'ACTIVE', 'public', 'Beauty conversion focused package', 'Includes engagement hook and comment-response support.', true, true, true, 57, 'within_12_hours'),
    ('30000000-0000-4000-8000-000000000006', '10000000-0000-4000-8000-000000000006', 'Food Spot Feature', 'Restaurant Feature Reel', 'Restaurant feature with menu and price sensitivity messaging.', 'INSTAGRAM', 'FOOD_BEVERAGE', 'PAID', 'PAID', 67000, 'PKR', '["1 reel", "offer mention", "location tag"]'::jsonb, 4, 1, 'ACTIVE', 'public', 'Restaurant growth unit', 'Best for app-delivery and local dine-in conversion pushes.', true, false, true, 49, 'within_24_hours'),
    ('30000000-0000-4000-8000-000000000007', '10000000-0000-4000-8000-000000000007', 'Student Prep Series', 'Exam Productivity Reel + Notes Carousel', 'Student prep campaign with practical planning templates.', 'INSTAGRAM', 'EDUCATION_CAREER', 'PAID', 'PAID', 52000, 'PKR', '["1 reel", "1 carousel post"]'::jsonb, 6, 1, 'ACTIVE', 'public', 'Student acquisition package', 'Useful for edtech trials and study-tool promotions.', true, false, false, 31, 'within_24_hours'),
    ('30000000-0000-4000-8000-000000000008', '10000000-0000-4000-8000-000000000008', 'Northern Route Vlog', 'Travel Vlog + Itinerary Stories', 'Domestic travel itinerary content with budget visibility.', 'YOUTUBE', 'TRAVEL_LIFESTYLE', 'PAID', 'PAID', 112000, 'PKR', '["1 vlog", "3 stories"]'::jsonb, 8, 2, 'ACTIVE', 'public', 'Domestic tourism storytelling', 'Strong for hospitality, transport and family-travel campaigns.', true, false, false, 36, 'within_24_hours'),
    ...
    ('30000000-0000-4000-8000-000000000011', '10000000-0000-4000-8000-000000000011', 'Daily Lifestyle Kit', 'Homecare Reel + Weekly Stories', 'Daily routine narrative for homecare and FMCG promotions.', 'INSTAGRAM', 'TRAVEL_LIFESTYLE', 'PAID', 'PAID', 59000, 'PKR', '["1 reel", "5 stories"]'::jsonb, 6, 1, 'ACTIVE', 'public', 'Lifestyle consistency package', 'Fits recurring visibility campaigns and value messaging.', true, false, false, 33, 'within_12_hours'),
    ...
    ('30000000-0000-4000-8000-000000000013', '10000000-0000-4000-8000-000000000013', 'Nutrition Habit Reel', 'Meal Plan Reel + Grocery Tips', 'Habit-focused wellness storytelling for family nutrition.', 'INSTAGRAM', 'FITNESS_HEALTH', 'PAID', 'PAID', 62000, 'PKR', '["1 reel", "3 tips stories"]'::jsonb, 5, 2, 'ACTIVE', 'public', 'Wellness routine package', 'Clear CTAs with practical daily implementation context.', true, false, false, 30, 'within_24_hours'),
    ...
    ('30000000-0000-4000-8000-000000000015', '10000000-0000-4000-8000-000000000015', 'Weekend Recipe Reel', 'Traditional Recipe Reel + Ingredient List', 'Recipe-led format optimized for saves and shares.', 'INSTAGRAM', 'FOOD_BEVERAGE', 'PAID', 'PAID', 64000, 'PKR', '["1 reel", "ingredient list story"]'::jsonb, 5, 1, 'ACTIVE', 'public', 'Food recipe conversion package', 'Built for FMCG and grocery category conversion flows.', true, false, true, 46, 'within_24_hours'),
    ...
    ('30000000-0000-4000-8000-000000000017', '10000000-0000-4000-8000-000000000017', 'Book Club Reel', 'Book Review Reel + Study Hacks', 'Reading culture and productivity hybrid content.', 'INSTAGRAM', 'EDUCATION_CAREER', 'PAID', 'PAID', 50000, 'PKR', '["1 reel", "2 story cards"]'::jsonb, 5, 1, 'ACTIVE', 'public', 'Education-adjacent package', 'Works for publishing, stationery and student-centric offers.', true, false, false, 25, 'within_12_hours'),
